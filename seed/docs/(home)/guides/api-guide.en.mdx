...
The stera smart one API is a REST‑based payments API. It supports operations used in day‑to‑day running such as charging and refunding.
...
For security, all API communication with the stera smart one servers must use HTTPS.

# Methods

Requests to the stera smart one API support three HTTP methods: GET, POST, and DELETE.
