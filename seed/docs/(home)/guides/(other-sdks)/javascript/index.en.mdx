...
The **elepay JavaScript SDK** integrates stera smart one into web applications.
This guide explains how to connect your web app with the stera smart one JavaScript SDK.
