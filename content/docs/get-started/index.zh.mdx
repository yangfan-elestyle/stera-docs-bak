...
**elepay iOS SDK**  は 3.1.1 から SPM に対応しました。
...
[決済方法](https://developer.elepay.io/docs/%E6%A6%82%E8%A6%81)ページをご参考ください。
...
> 📘 Public Key について
>
> `ELEPAY_APP_PUBLIC_KEY`  を[「elepay 管理画面」](https://dashboard.elepay.io/)で発行したものに変更してください
...
詳細は  [API リファレンス](https://developer.elepay.io/reference#createcode)をご参照ください。
...
[エラーコード](https://developer.elepay.io/docs/error-code)  にエラーコードリストをご参照ください。
...
2.  Apple Pay の証明書を[「elepay 管理画面」-「開発設定」-「Apple Pay」](https://dashboard.elepay.io/)にアップロードしてください。
    証明書の作成方法は[こちらのドキュメント](https://developer.elepay.io/docs/apple-pay#section-ios-)でご参照ください。
...
[決済方法](https://developer.elepay.io/docs/summary)ページをご参考ください。
