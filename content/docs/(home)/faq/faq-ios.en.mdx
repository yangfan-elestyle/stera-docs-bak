...
3.  In Xcode settings, ensure Apple Pay is enabled and confirm that you have uploaded the [Apple Pay certificate](/guides/mobile/payment-methods-config#apple-pay) to the <EText name="elepay" /> dashboard.
