...
**elepay Android SDK**  は elepay を Android アプリに導入するための SDK です。<br />
...
> 🚧 必ずお忘れずに
>
> 上記コードの中、`<data android:scheme="ep1234567890abcdef" />`の`scheme`は elepay 専用 URL Scheme に書き換えてください。取得方法は「[iOS / Android SDK 用 URL Scheme の取得](/sdks/url-scheme)」までご参照ください。
