...
The **elepay JavaScript SDK** integrates <EText name="elepay" /> into web applications.
This guide explains how to connect your web app with the <EText name="elepay" /> JavaScript SDK.
