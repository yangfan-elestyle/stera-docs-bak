...
See “[Obtaining URL Scheme for iOS / Android SDK](/sdks/url-scheme)” for how to get the <EText name="elepay" />‑specific URL Scheme.
...
See the [Payment Methods](/get-started/pays) page.
...
2. Upload your Apple Pay certificate to [“<EText name="elepay" /> Dashboard” → “Developer Settings” → “Apple Pay”](https://dashboard.elepay.io/).  
   For how to create the certificate, see [this document](/get-started/pays#apple-pay).
