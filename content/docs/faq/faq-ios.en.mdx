...
3.  In Xcode settings, ensure Apple Pay is enabled and confirm that you have uploaded the [Apple Pay certificate](/get-started/pays#apple-pay) to the elepay dashboard.
