  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          role="menu"
          className="absolute top-full right-0 mt-2 z-50 flex flex-col rounded-xl border bg-fd-popover/60 backdrop-blur-lg text-fd-popover-foreground shadow-lg p-2 min-w-[240px] max-w-[98vw]"
        >
          {items.map((item) => (
            <a
              key={item.href}
              ...
              className="text-sm p-2 rounded-lg inline-flex items-center gap-2 whitespace-nowrap hover:bg-fd-accent hover:text-fd-accent-foreground [&_svg]:size-4"
            >
              {item.icon}
              {item.title}
