  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          role="menu"
          className="absolute top-full left-0 mt-2 z-50 flex flex-col rounded-xl border bg-fd-popover/60 backdrop-blur-lg text-fd-popover-foreground shadow-lg p-2 min-w-[240px] max-w-[98vw]"
        >
          {items.map((item) => (
            <a
              key={item.href}
